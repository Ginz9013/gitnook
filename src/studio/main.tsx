...
import { App } from '@/App';
import { MEDIA, applyTheme, storedTheme } from '@/components/ThemeToggle';
import '@/index.css';
 ...
 * 一 unmount（票 B2 已經把它搬進 header）跟隨系統就靜靜死掉，而那種壞法
...
/**
 * 切換器**現在住在 header 裡**（`board/BoardHeader.tsx`，票 B2）—— 批 A 把它
 * 暫時固定在右上角是知情的兩步，這一步把它收回版面上該在的位置。
 */
